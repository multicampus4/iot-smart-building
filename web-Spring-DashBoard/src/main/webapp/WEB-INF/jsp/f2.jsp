	<div class="card-header">
		<i class="header-icon lnr-gift icon-gradient bg-grow-early"> </i>Floor2
		<div class="btn-actions-pane-right">
			<div class="nav">
				<a data-toggle="tab" href="#tab-eg4-0"
					...
					3</a> <a data-toggle="tab" href="#tab-eg4-0"
					class="border-0 btn-pill btn-wide btn-transition btn btn-outline-danger">Tab
					4</a> <a data-toggle="tab" href="#tab-eg4-0"
					class="border-0 btn-pill btn-wide btn-transition btn btn-outline-danger">Tab
					5</a> <a data-toggle="tab" href="#tab-eg4-0"
					class="border-0 btn-pill btn-wide btn-transition btn btn-outline-danger">Tab
					6</a> <a data-toggle="tab" href="#tab-eg4-0"
					class="border-0 btn-pill btn-wide btn-transition btn btn-outline-danger">Tab
					7</a>
			</div>
		</div>
